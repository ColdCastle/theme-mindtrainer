...
<div class="col-md-8">
			...
			<p class="credits" style="text-align: center;"><?php if ( $foto ) { ?>Fotos: <a <?php if ( $foto_link ) { ?>href="http://<?php echo $foto_link; ?>"  target="_blank"<?php } ?>><?php echo $foto; ?></a> - <?php } ?><?php if ( $webmaster ) { ?>Webmaster: <a <?php if ( $webmaster_link ) { ?>href="http://<?php echo $webmaster_link; ?>"  target="_blank"<?php } ?>><?php echo $webmaster; ?></a><?php } ?><?php if ( $grafik ) { ?> - Grafik: <a <?php if ( $grafik_link ) { ?>href="http://<?php echo $grafik_link; ?>" target="_blank"<?php } ?>><?php echo $grafik; ?></a><?php } ?><br><i style="font-size: 14px !important;" class="fa fa-copyright"></i> <?php echo $copyright; ?></p>
</div>
<div class="col-md-2"></div>
